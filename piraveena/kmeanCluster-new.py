...
basePath = "/home/piraveena/fyp_data/targetvectors-1/"
# model = "/model/"

# path = "/home/piraveena/Documents/data/model/vectors.txt"
# path = "/home/piraveena/home/target_after1/model/vectors.txt"
output_image_path = "kmeansImages/relations/iter1/"
output_cluster_path ="clusterPath/relations/iter1/"
...
def getVector(lemma):
    ...
    plt.savefig(output_image_path + lemma+ " embedding.png")
    plt.show()
    plt.close()
    return words,vecs
...
lemma = "book_N"
NUMBER_OF_SENSES= no_of_senses("book")
words, vecs = getVector(lemma)
kmeans_clustering(lemma,words, vecs, NUMBER_OF_SENSES-6)

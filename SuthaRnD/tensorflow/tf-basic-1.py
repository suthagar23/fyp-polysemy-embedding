...
inputPath = basePath + "pre-processed-final-files/news.en-00001-of-00100/"
inputFileName = inputPath + "news.en-00001-of-00100-out-0-output.txt"
...
for inputFileName in all_files:
    if os.path.isfile(inputPath + inputFileName):
      print("Processing file : ", filename)
      vocabulary.extend(read_data(filename))
  ...
  for step in xrange(num_steps):
    ...
    if step % 10000 == 0:
      ...
      for i in xrange(valid_size):
        if valid_examples[i] < len(reverse_dictionary):

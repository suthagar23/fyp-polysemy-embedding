...
flags.DEFINE_integer('--buf', 4096, 'The size for each shard')
  ...
  for lineno, line in enumerate(lines, start=1):
    ...
    if lineno % 100000 == 0:
      ...
      sys.stdout.write('\rComputing vocabulary: %0.1f%% (%d/%d)...' % (
          100.0 * position / nbytes, position, nbytes))
      sys.stdout.flush()

  sys.stdout.write('\n')

  # sys.stdout.write('vocab size %d' % len(vocab))
...
def main(_):
  # FLAGS.output_dir = "/home/suthagar/Desktop/swivel/output/"
  # FLAGS.input = "/home/suthagar/Desktop/swivel/news.en-00099-of-00100"
